...
object EmptyQueue : Queue<Nothing>,
    ...
    override fun add(element: Nothing) = throw IllegalStateException("Cannot add elements to an Empty Queue.")

    override fun addAll(elements: Collection<Nothing>) = throw IllegalStateException("Cannot add elements to an Empty Queue.")

    override fun remove() = throw IllegalStateException("Cannot remove elements from an Empty Queue.")
}